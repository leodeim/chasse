...
export default function Controls() {
    ...
    return (
        <div className="flex sm:flex-col justify-center sm:ml-4 text-cGreen">
            <div className="flex sm:flex-col mt-4 pb-2 sm:mt-0 sm:pt-4 sm:pb-4 bg-cYellow rounded-full">
                ...
                <button className="pt-2 pl-4 pr-4 sm:pl-2 sm:pr-2 sm:mb-2 text-cRed" onClick={() => clearBoard()}>
                    <EndIcon />
                </button>
            </div>
        </div>
